db.customers.insertMany([
    { name: "Michael Johnson", email: "michaelj@example.com", address: { street: "123 Main St", city: "Springfield", zipcode: "12345" }, phone: "555-1234", registered_on: new Date("2023-01-01T12:00:00Z") },
    { name: "Emma Williams", email: "emmawilliams@example.com", address: { street: "456 Elm St", city: "Shelbyville", zipcode: "54321" }, phone: "555-5678", registered_on: new Date("2023-02-15T12:00:00Z") },
    { name: "Olivia Brown", email: "oliviab@example.com", address: { street: "789 Oak St", city: "Springfield", zipcode: "12345" }, phone: "555-8765", registered_on: new Date("2023-03-10T12:00:00Z") },
    { name: "Noah Davis", email: "noahdavis@example.com", address: { street: "321 Pine St", city: "Shelbyville", zipcode: "54321" }, phone: "555-4321", registered_on: new Date("2023-04-20T12:00:00Z") },
    { name: "Sophia Martinez", email: "sophiamartinez@example.com", address: { street: "654 Maple St", city: "Springfield", zipcode: "12345" }, phone: "555-6789", registered_on: new Date("2023-05-05T12:00:00Z") }
]);

db.customers.findOne({ name: "Michael Johnson" })._id;
db.customers.findOne({ name: "Emma Williams" })._id;
db.customers.findOne({ name: "Olivia Brown" })._id;
db.customers.findOne({ name: "Noah Davis" })._id;
db.customers.findOne({ name: "Sophia Martinez" })._id;
